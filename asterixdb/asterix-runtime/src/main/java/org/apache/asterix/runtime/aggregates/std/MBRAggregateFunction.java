...
public class MBRAggregateFunction extends AbstractMBRAggregateFunction {

    public MBRAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context, SourceLocation sourceLoc)
