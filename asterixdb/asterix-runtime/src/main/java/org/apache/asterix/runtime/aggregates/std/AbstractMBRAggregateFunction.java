...
public abstract class AbstractMBRAggregateFunction extends AbstractAggregateFunction {
    ...
    // Constructor
    public AbstractMBRAggregateFunction(IScalarEvaluatorFactory[] args, IEvaluatorContext context,
