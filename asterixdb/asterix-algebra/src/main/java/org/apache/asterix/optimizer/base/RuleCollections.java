...
public final class RuleCollections {
    ...
    public static final List<IAlgebraicRewriteRule> buildFilterRefineSpatialJoinRuleCollection() {
        List<IAlgebraicRewriteRule> filterRefineJoinRule = new LinkedList<>();
        filterRefineJoinRule.add(new FilterRefineSpatialJoin());
        return filterRefineJoinRule;
    }

    public static final List<IAlgebraicRewriteRule> buildFilterRefineSpatialDistanceJoinRuleCollection() {
        List<IAlgebraicRewriteRule> filterRefineDistanceJoinRule = new LinkedList<>();
        filterRefineDistanceJoinRule.add(new FilterRefineSpatialDistanceJoin());
        return filterRefineDistanceJoinRule;
    }
}
